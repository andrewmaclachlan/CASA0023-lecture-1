...
* Weekly learning diary using Quarto:
  ...
  * no specific formatting requirement (e.g. written response or flowcharts)
      - Summary: summary of the content. . It will also include independent thought such as questions, limitations, benefits
      - Applications: Discussion of how data / concepts / methods (or related concepts) been applied in literature / policy or other studies
...
**Much more on this later in the term**
  ...
  * Polarization
     * Applicable to Radar: Electromagnetic waves are polarized and the direction(horizontal (H) or vertical (V)) depends on the oscillation of the electromagnetic field. When they are reflected from the surface the waves can be linked to surface properties - roughness, shape, orientation, moisture, salinity, density. 
...
* Type of orbit 
  ...
  * sunsynchronous orbit = in sync with the sun - pass over the same spot at the same time each day
